...
> = ({}: CrudInterfaceProps) => {
  return (
    <div className="inline-flex items-center rounded-md pb-2 shadow-sm">
      ...
      <button className="inline-flex items-center space-x-1 rounded-r-lg border border-slate-200 bg-white px-4 py-2 text-sm font-medium text-slate-800 hover:bg-slate-100 hover:text-blue-600">
        <span>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
